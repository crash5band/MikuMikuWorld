...
namespace MikuMikuWorld
{
	...
	const std::array<std::string, 3> FORMAT_OPTIONS = {
	...
	void ScoreSerializeWindow::openDeserializeDialogFromPicker()
	{
		...
		{
		case 0: // MMWS
			controller = std::make_unique<DefaultScoreSerializeController>(std::make_unique<NativeScoreSerializer>(), pendingFilename);
			break;
		case 1: // SUS
