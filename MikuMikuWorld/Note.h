...
namespace MikuMikuWorld
{
	...
	constexpr const char* SE_NAMES[] = { SE_PERFECT,          SE_FLICK,
		                                 SE_CONNECT,          SE_TICK,
		                                 SE_CRITICAL_TAP,     SE_CRITICAL_FLICK,
		                                 SE_CRITICAL_CONNECT, SE_CRITICAL_TICK,
		                                 SE_FRICTION,         SE_CRITICAL_FRICTION };
