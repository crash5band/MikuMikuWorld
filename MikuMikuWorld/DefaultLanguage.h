...
namespace MikuMikuWorld
{
	extern std::map<std::string, std::string> en
	{
		...
		{"sonolus_collection", "Sonolus Collection"},
		{"select_level", "Select a level"},
		{"level_id_input_hint", "Level ID (leaves empty for auto generate id)"},
		{"level_data_incompat_msg1", "Level data is incompatible with "},
		{"level_data_incompat_msg2", ""},
		{"level_data_not_found", "Level data is missing!"},
		...
		{"music_preview_file", "Music Preview File"},
