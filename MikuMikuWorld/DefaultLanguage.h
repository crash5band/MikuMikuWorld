...
namespace MikuMikuWorld
{
	extern std::map<std::string, std::string> en
	{
		...
		{"detect_chart_issues", "Detect Chart Issues"},
		{"view", "View"},
		...
		{"holds_animation", "Animate Long Note"},
		{"simultaneous_lines", "Multi-Tap Line"},
		{"notes_effect", "Notes Effect"},
		{"effects_normal", "Normal"},
		{"effects_reduced", "Reduced"},
		{"holds_alpha", "Long Notes Transparency"},
		{"guides_alpha", "Guide Notes Transparency"},
		...
		{"chart_issue_list", "Issue List"},
		{"errors", "Errors"},
		{"warnings", "Warnings"},
		{"code", "Code"},
		{"track", "Track"},
		{"category", "Category"},
		{"chart_issue_not_run", "No diagnostics yet. Use Edit -> Detect Chart Issues."},
		{"chart_issue_no_issues", "No chart issues were found."},
		{"chart_issue_filter_no_match", "No items match the current filter."},
		{"chart_issue_select_hint", "Select an item to inspect details."},
