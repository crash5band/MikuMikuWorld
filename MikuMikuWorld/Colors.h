...
namespace MikuMikuWorld
{
	...
	const ImU32 speedColor		= ImGui::ColorConvertFloat4ToU32(ImVec4(0.99f, 0.35f, 0.25f, 1.00f));
	const ImU32 inactiveSpeedColor		= ImGui::ColorConvertFloat4ToU32(ImVec4(0.99f, 0.35f, 0.25f, 0.50f));
