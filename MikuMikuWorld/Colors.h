...
namespace MikuMikuWorld
{
	...
	const ImU32 measureTxtColor =
	    ImGui::ColorConvertFloat4ToU32(ImVec4(1.00f, 1.00f, 1.00f, 1.00f));
	...
	const ImU32 selectionColor1 =
	    ImGui::ColorConvertFloat4ToU32(ImVec4(0.40f, 0.40f, 0.40f, 0.45f));
	const ImU32 selectionColor2 =
	    ImGui::ColorConvertFloat4ToU32(ImVec4(0.42f, 0.46f, 1.00f, 0.50f));
	const ImU32 selectionShadow =
	    ImGui::ColorConvertFloat4ToU32(ImVec4(0.20f, 0.20f, 0.20f, 0.65f));
	...
	{
		return ImVec4(std::max(0.0f, color.x - 0.10f), std::max(0.0f, color.y - 0.10f),
		              std::max(0.0f, color.z - 0.10f), 1.0f);
	}
